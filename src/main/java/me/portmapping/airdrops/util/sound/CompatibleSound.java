package me.portmapping.airdrops.util.sound;
...
public enum CompatibleSound {
    ...
    ZOMBIE_WOODBREAK("ZOMBIE_WOODBREAK", "ENTITY_ZOMBIE_BREAK_WOODEN_DOOR"),
    ...
    public Sound getSound() {
        ...
        else if (ServerUtil.SERVER_VERSION_INT >= 14) {
    ...
    public static CompatibleSound getSound(String name) {
        if (name == null || name.isEmpty()) return null;

        for (CompatibleSound sound : values()) {
            if ((sound.sound8 != null && sound.sound8.equalsIgnoreCase(name)) || (sound.sound912 != null && sound.sound912.equalsIgnoreCase(name)) || (sound.sound13 != null && sound.sound13.equalsIgnoreCase(name))) {
                return sound;
            }
        }
